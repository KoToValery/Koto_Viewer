            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _buildInfoRow('Width (ΔX)', DxfMath.formatDistance(document.width)),
                      const Divider(height: 16),
                      _buildInfoRow('Height (ΔY)', DxfMath.formatDistance(document.height)),
                      const Divider(height: 16),
                      _buildInfoRow('X Range', '${DxfMath.formatDistance(bounds.left)} → ${DxfMath.formatDistance(bounds.right)}'),
                      const Divider(height: 16),
                      _buildInfoRow('Y Range', '${DxfMath.formatDistance(bounds.top)} → ${DxfMath.formatDistance(bounds.bottom)}'),
                      const Divider(height: 16),
