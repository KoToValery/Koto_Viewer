...
/// Encapsulated PostScript (.eps) Vector Viewer Screen.
          ...
          ? const Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text('Loading EPS Vector Graphic...'),
                ],
              ),
            )
          : _errorMessage != null
                  ...
                  children: [
                    ...
                    InteractiveViewer(
                      ...
                      child: Center(
                        child: CustomPaint(
                          size: Size(
                            _document!.metadata.boundingBox.width,
                            _document!.metadata.boundingBox.height,
                          ),
                          painter: EpsPainter(
                            document: _document!,
                            theme: _canvasTheme,
